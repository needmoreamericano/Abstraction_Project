...
def get_login_form(request: Request):
    return templates.TemplateResponse('front1.html', context={'request':request})
...
def login(request: Request, word:str=Form(...)):
    contents, stock = new_ml_code.main(word)


    return templates.TemplateResponse("front2.html", {"request": request, "word": word, "contents": contents, "stock": stock})
